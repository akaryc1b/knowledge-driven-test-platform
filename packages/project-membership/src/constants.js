...
const VIEW_ACTIONS = ['KNOWLEDGE_READ', 'SNAPSHOT_READ'];
export const DEFAULT_ROLE_ACTIONS = Object.freeze({
  ...
  AUDITOR: Object.freeze(['KNOWLEDGE_READ', 'AUDIT_READ', 'SNAPSHOT_READ']),
  AUTOMATION: Object.freeze(['KNOWLEDGE_READ', 'SNAPSHOT_PERSIST', 'SNAPSHOT_READ']),
